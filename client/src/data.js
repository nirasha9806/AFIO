...
export const news = [
  {
    ...
    newsTitle: 'COS',
    newsText:
      'London-based fashion brand COS has launched Resell—a new digital space that provides a platform to buy and sell pre-loved COS clothing, offering the...'
  },
  {
    id: 2,
    newsTitle: 'PVH',
    newsText:
      'PVH Corp, a global apparel companies, reported 33 per cent revenue decline to $1.58 billion in its second quarter (Q2) FY20 ended on August 2,...'
  },
  {
    id: 3,
    newsTitle: 'EU',
    newsText:
      'Bangladesh has failed to arrive at a decision on a European Union (EU) proposal to offer incentives for jobless garment factory workers in the...'
  },
  {
    id: 4,
    newsTitle: 'Indian Ltd',
    newsText:
      'VIP Clothing Ltd, the Indian innerwear manufacturer, has forayed into the medical chain distribution. VIP has added re-usable 4-ply soft cotton cloth ...'
  },
];
